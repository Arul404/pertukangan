...
<div class="row justify-content-center">
    <div class="col-lg-7">
        ...
        <form method="post" action="<?= module_url('akun-bsre/save') ?>" class="card shadow-sm" id="bsre-form">
            <?= csrf_field() ?>
            <div class="card-body">
                <div class="mb-3">
        ...
        <?php else: ?>
            <p class="text-muted small mt-3">
                ...
                Simpan kredensial dulu, lalu opsi <strong>Hubungkan</strong> (login + OTP) akan muncul di sini.
            </p>
        <?php endif; ?>
    </div>
</div>
