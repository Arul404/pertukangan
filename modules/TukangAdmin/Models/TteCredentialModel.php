...
/**
 * Satu set kredensial login TTE.
 *
 * Kata sandi disimpan terenkripsi: enkripsi dilakukan di sini sebelum insert,
 * dekripsi lewat {@see self::plainPassword()} tepat saat scraper hendak login.
 * Kolom `password` di tabel karena itu berisi ciphertext, bukan kata sandi asli.
 */
class TteCredentialModel extends Model
{
    protected $table         = 'tte_credentials';
